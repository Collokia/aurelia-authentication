define(["exports", "./authFilterValueConverter", "./authenticatedValueConverter", "./authenticatedFilterValueConverter", "extend", "aurelia-logging", "jwt-decode", "aurelia-pal", "aurelia-path", "aurelia-dependency-injection", "aurelia-event-aggregator", "aurelia-metadata", "aurelia-templating-resources", "aurelia-router", "aurelia-fetch-client", "aurelia-api", "amazon-cognito-identity-js/dist/amazon-cognito-identity.min"], function (exports, _authFilterValueConverter, _authenticatedValueConverter, _authenticatedFilterValueConverter, _extend, _aureliaLogging, _jwtDecode, _aureliaPal, _aureliaPath, _aureliaDependencyInjection, _aureliaEventAggregator, _aureliaMetadata, _aureliaTemplatingResources, _aureliaRouter, _aureliaFetchClient, _aureliaApi, _amazonCognitoIdentity) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.FetchConfig = exports.AuthorizeStep = exports.AuthenticateStep = exports.AuthService = exports.Authentication = exports.OAuth2 = exports.OAuth1 = exports.AuthLock = exports.Storage = exports.BaseConfig = exports.AuthError = exports.CognitoAuth = exports.Popup = undefined;
    ...
    function AuthService(authentication, config, bindingSignaler, eventAggregator) {
      ...
      this.storageEventHandler = function (event) {
        ...
        if (_this13.config.storageChangedRedirect && wasAuthenticated !== _this13.authenticated) {
          _aureliaPal.PLATFORM.location.assign(_this13.config.storageChangedRedirect);
        }
      };
    ...
    AuthService.prototype.setTimeout = function setTimeout(ttl) {
      ...
      this.timeoutID = _aureliaPal.PLATFORM.global.setTimeout(function () {
        ...
        if (_this14.config.expiredRedirect) {
          _aureliaPal.PLATFORM.location.assign(_this14.config.expiredRedirect);
        }
      }, ttl);
    };
